...
class History_model extends CI_Model{
	...
	public function cacgoi(){
		...
		//if( date("H", time()) >= 22 || ( date("H", time()) >= 0 && date("H", time())<=2) ){
			// return  array(
			// '0' => array('ten' => '4p','tgian' => 0.06, 'gia' => 500),
			// '1' => array('ten' => '6h','tgian' => 6, 'gia' => 10000),
			// '3' => array('ten' => '9h','tgian' => 9, 'gia' => 15000),
			// '5' => array('ten' => '12h','tgian' => 12, 'gia' => 20000),
			// '7' => array('ten' => '24h','tgian' => 24, 'gia' => 30000), 
			// );
	...
	public function cacgoi_dattrc(){
		return $this->cacgoi();
		//if( date("H", time()) >= 17 || ( date("H", time()) >= 0 && date("H", time())<=2) ){
			return  array(
			'0' => array('ten' => '4p','tgian' => 0.06, 'gia' => 500),
			'1' => array('ten' => '6h','tgian' => 6, 'gia' => 10000),
			'3' => array('ten' => '9h','tgian' => 9, 'gia' => 15000),
	...
	public function pushcrew($acc_name = ''){
		$title = 'Lá»—i Ä‘á»•i pass '.$acc_name.'.';
		$message = 'LÃºc '.date("H:i:s d/m/Y", time()).'';
