...
<?php echo form_open($this->uri->uri_string(),'class=""');?>
	<div class="form-group">
		...
		<input type="text" class="form-control" id="acc_name" placeholder="" name="acc_name" required>
	</div>
	<div class="form-group">
		<label for="acc_pass">Auth key</label>
		<input type="text" class="form-control" id="acc_pass" placeholder="" name="acc_pass" required >
	</div>
	<div class="form-group">
