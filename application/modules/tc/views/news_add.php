...
<div class="form-group">
    ...
    <div class="col-md-10">
        <input name="n_active" class="form_control" type="checkbox" checked="true" />
    </div>
</div>
    ...
    <div class="col-md-10">
        <select name="n_nc_id" class="form-control">
            <?php print_r($categories); foreach($categories AS $category) { ?>
                <option value="<?php echo $category->nc_id;?>">
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <textarea name="n_description" class="ckeditor" id="editor0"></textarea>
    </div>
</div>
<div class="form-group">
    <label for="n_nc_id" class="col-md-2 control-label"><?php echo form_label('Nội dung chi tiết', 'n_content'); ?></label>
    <div class="col-md-10">
        <textarea name="n_content" class="ckeditor" id="editor1" rows="2"></textarea>
    </div>
</div>
<div class="form-group">
