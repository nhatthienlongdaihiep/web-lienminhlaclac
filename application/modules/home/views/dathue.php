...
<?php 	$ds_thue = array();
			...
			if($dem_acc_thue > 0){
				...
				echo '<tr><th>Tài khoản</th><th>Bắt đầu</th><th>Kết thúc</th><th>AuthKey ( Đổi trước 30 phút )</th></tr>';
				foreach($accs_dangthue AS $acc){
			...
			echo '<span style="color:#fff103;font-size:30px;text-align:center;"><br/>Nếu bạn không thấy key thì F5 load lại trang<br/><br/></span>';
		}
